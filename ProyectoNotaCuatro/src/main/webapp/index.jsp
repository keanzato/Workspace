...
<li><a href="#"><i class="fa fa-youtube"></i></a></li>
 ...
 <div class="collapse navbar-collapse menubar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/ProyectoNotaCuatro/ServletIndex"><i class="fa fa-fw fa-home"></i>Inicio</a>
					
					</li>
                    <li class='dropdown'><a href="#" class='dropdown-toggle' data-toggle='dropdown'><i class="fa fa-fw fa-support"></i>Ayuda?</a>
                    ...
                    <li><a href="/ProyectoNotaCuatro/ServletMenu"><i class="fa fa-fw fa-th"></i>Platos para hoy</a></li>
                    
                    
                    <li><a href="#"><i class="fa fa-fw fa-bar-chart-o"></i>Unete a nosotros</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-users"></i>Usuario<i class="icon-angle-down"></i></a>
                        <ul class="dropdown-menu">
...
<!--GALLERY STARTS HERE -->
  ...
  <section class='gallery'>
   ...
   <div class="home-caption">
                <div class="home-title">Tus platos favoritos, cerca y como quieras.</div>
                <div class="home-subtitle">Pidelo ahora, ingresa como usuario y disfruta de las mejores comidas</div>
  ...
  <div class="row">
        <div  class="col-sm-4 shym-option-container">
          <span data-scroll-reveal="wait 0.25s, then enter top and move 40px over 1s" ><i class="fa fa-camera"></i></span>
        ...
        <div  class="col-sm-4  shym-option-container">
          <span data-scroll-reveal="wait 0.25s, then enter top and move 40px over 1s" ><i class="fa fa-dashboard"></i></span>
        ...
        <div  class="col-sm-4  shym-option-container">
          <span data-scroll-reveal="wait 0.25s, then enter top and move 40px over 1s"><i class="fa fa-eye"></i></span>
...
<div class='shym-user-title' >
      ...
      <div id="owl-team"> 
        ...
        <!--======= SLIDER PART =========-->
        <div class="team">
          <div class="img"> <img class="img-responsive" src="img/team-1.jpg" alt="" >
            <div class="over">
			<i class="fa fa-eye"></i>
        ...
        <!--======= SLIDER PART =========-->
        <div class="team">
          <div class="img"> <img class="img-responsive" src="img/team-2.jpg" alt="" >
            <div class="over">
			<i class="fa fa-eye"></i>
              <div class="des"> <a href="#"></a>
        ...
        <!--======= SLIDER PART =========-->
        <div class="team">
          <div class="img"> <img class="img-responsive" src="img/team-3.jpg" alt="" >
            <div class="over">
              <i class="fa fa-eye"></i>
              <div class="des"> <a href="#"></a>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500 when an unknown printer.
        ...
        <!--======= SLIDER PART=========-->
        <div class="team">
          <div class="img"> <img class="img-responsive" src="img/team-4.jpg" alt="" >
            <div class="over">
              <i class="fa fa-eye"></i>
              <div class="des"> <a href="#"></a>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500 when an unknown printer.
...
<p class='shym-text-left' >Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation +0123 456 70 80</p></div><div class=' col-sm-2 '><button class='btn btn-warning pull-right ' style='margin-top:50px;'>Quote</button></div>
</div>
</div>
</div>
</section>
