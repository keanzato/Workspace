...
<body>
	...
	<header class="navbar navbar-inverse navbar-fixed-top heading"
		...
		<div class="container">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle togglebutton"
				...
				<a class='shym-logo'> <img src='img/logo-shym.png' alt='Shym' /></a>
			...
			<div class="collapse navbar-collapse menubar">
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="/ProyectoNotaCuatro/ServletIndex"><i class="fa fa-fw fa-home"></i>Inicio</a>

					</li>
					<li class='dropdown'><a href="#" class='dropdown-toggle'
						data-toggle='dropdown'><i class="fa fa-fw fa-support"></i>Ayuda?</a>
						<ul class='dropdown-menu'>
							<li><a href="#"></a></li></li>
				</ul>
				<li><a href="/ProyectoNotaCuatro/ServletMenu"><i
						class="fa fa-fw fa-th"></i>Platos para hoy</a></li>


				<li><a href="#"><i class="fa fa-fw fa-bar-chart-o"></i>Unete
						a nosotros</a></li>
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown"><i class="fa fa-fw fa-users"></i>Usuario<i
	...
	<section class='gallery'>
		...
		<div class="home-caption">
			<div class="home-title">Tus platos favoritos, cerca y como
				quieras.</div>
			<div class="home-subtitle">Pidelo ahora, ingresa como usuario y
				disfruta de las mejores comidas</div>
			<a href="#" class="btn btn-lg downloadbtn">Pedir Ya!</a>
		</div>
		...
		<div class='container'>
			<div class="row">
				<div class="col-sm-4 shym-option-container">
					<span
						data-scroll-reveal="wait 0.25s, then enter top and move 40px over 1s"><i
		...
		<div class='container'>
			...
			<div class='row'>
				<div class='col-xs-12 shym-application-data'>
					<div class="apps">
						<a href="#"
							data-scroll-reveal="wait 0.25s, then enter left and move 40px over 1s"><i
							class="fa fa-android"></i></a> <a href="#"
							data-scroll-reveal="wait 0.25s, then enter right and move 40px over 1s"><i
							class="fa fa-apple"></i></a> <a href="#"
							data-scroll-reveal="wait 0.25s, then enter bottom and move 40px over 1s"><i
							class="fa fa-windows"></i></a> <a href="#"
							data-scroll-reveal="wait 0.25s, then enter top and move 40px over 1s"><i
						...
						<div class="over">
							...
							<div class="des">
								...
								<p>Lorem Ipsum is simply dummy text of the printing and
									...
									printer. Lorem Ipsum has been the industry's standard dummy
		...
		<div class='container'>
			<div class='row'>
				...
				<div class='col-md-12 col-sm-12 col-xs-12'>
						...
						<div class='picture-info'
							...
							<div class="shym-overlay">
								<div class="shym-picture-detail-inner">
									...
									<a href="#" rel="prettyPhoto"><i class="fa fa-eye"></i>
										View</a>
								</div>
							</div>
						</div>
					...
					<div class='col-sm-3 '>
						<div class='picture-info'
							data-scroll-reveal="wait 0.25s, then enter left and move 40px over 1s">
					...
					<div class='col-sm-3'>
						<div class='picture-info'
							data-scroll-reveal="wait 0.25s, then enter bottom and move 40px over 1s">
					...
					<div class='col-sm-3'>
						<div class='picture-info'
							data-scroll-reveal="wait 0.25s, then enter top and move 40px over 1s">
			...
			<div class='row'>
				<div class='col-md-12 col-sm-12 col-xs-12'>
					<div class='col-sm-10 col-xs-10 pull-left'>
						<h3 class='shym-text-left'>Have a question or need a custom
							quote?</h3>
						<p class='shym-text-left'>Lorem ipsum dolor sit amet,
					...
					<div class=' col-sm-2 '>
						<button class='btn btn-warning pull-right '
							style='margin-top: 50px;'>Quote</button>
					</div>
				</div>
			</div>
		</div>
	...
	<footer class="shym-contact">
						...
						<div class="col-md-6 col-sm-6">
							<div class="row">
								<div class="col-sm-6">
									<i class="ion-flag"></i>
									<h4>ABOUT US</h4>
									<p>Temporibus autem quisbusdam et aut officiis debitis aut
										rerum nece sitatibus sape eveniet ut et voluptate rerum.</p>
								</div>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label><span>Name</span> <input name="name"
										...
										<div class="col-md-12">
											<label> <span>Message</span> <textarea name="message"
		...
		<div class="copyrights">
			<div class="container">
				...
				<p class="pull-right">
					App Landing Page Designed and Developed by <a
						href='http://www.scriptcafe.in'>Scriptcafe.in </a>
				</p>
			</div>
	</footer>
